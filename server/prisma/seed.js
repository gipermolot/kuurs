...
async function main() {
 ...
 const books = [
  ...
  // Леся Українка
  { title: "Лісова пісня", authorName: "Леся Українка", categoryName: "Поезія", published_year: 1911, description: "Драматична поема" },
  { title: "Бояриня", authorName: "Леся Українка", categoryName: "Поезія", published_year: 1910, description: "Поетична драма" },
  ...
  { title: "В неділю рано зілля копала", authorName: "Ольга Кобилянська", categoryName: "Проза", published_year: 1898, description: "Повість про жіночі долі" },
  { title: "У неділю рано зілля копала", authorName: "Ольга Кобилянська", categoryName: "Проза", published_year: 1899, description: "Збірка оповідань" },
  ...
  // Микола Хвильовий
  { title: "Я (Романтика)", authorName: "Микола Хвильовий", categoryName: "Проза", published_year: 1920, description: "Новела про психологічні переживання" },
  ...
  // Василь Стефаник
  { title: "Камінний хрест", authorName: "Василь Стефаник", categoryName: "Проза", published_year: 1900, description: "Оповідання про селянські страждання" },
  ...
  { title: "Наталка Полтавка", authorName: "Іван Котляревський", categoryName: "Проза", published_year: 1819, description: "Драма" },
  ...
  // Пантелеймон Куліш
  { title: "Чорна рада", authorName: "Пантелеймон Куліш", categoryName: "Проза", published_year: 1857, description: "Історичний роман" },
